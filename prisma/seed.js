...
async function main() {
  ...
  await prisma.pegawai.createMany({
    data: [
      { id: 1, nip: '198501012010011001', nama_pegawai: 'Ahmad Fauzi', email: 'ahmad.fauzi@kepegawaian.go.id', nomor_hp: '+6281234567890', tempat_lahir: 'Jakarta', id_kecamatan: 1, alamat_lengkap: 'Jl. Merdeka No. 10, Cempaka Putih', jarak_rumah_kantor: 5, tanggal_lahir: new Date('1985-01-01'), status_kawin: 'Kawin', jumlah_anak: 2, tanggal_masuk: new Date('2010-01-15'), id_jabatan: 1, id_departemen: 9, usia: 41, status: 'Aktif', status_kontrak: 'PKWTT', jenis_kelamin: "Pria" },
      { id: 2, nip: '199002152012022001', nama_pegawai: 'Rina Marlina', email: 'rina.marlina@kepegawaian.go.id', nomor_hp: '+6281234567891', tempat_lahir: 'Bandung', id_kecamatan: 3, alamat_lengkap: 'Jl. Kemayoran Jaya No. 25', jarak_rumah_kantor: 8, tanggal_lahir: new Date('1990-02-15'), status_kawin: 'Kawin', jumlah_anak: 1, tanggal_masuk: new Date('2012-02-20'), id_jabatan: 1, id_departemen: 11, usia: 36, status: 'Aktif', status_kontrak: 'PKWT', jenis_kelamin: "Wanita" },
      { id: 3, nip: '199208302015032002', nama_pegawai: 'Budi Santoso', email: 'budi.santoso@kepegawaian.go.id', nomor_hp: '+6281234567892', tempat_lahir: 'Surabaya', id_kecamatan: 5, alamat_lengkap: 'Jl. Senen Raya No. 88', jarak_rumah_kantor: 3, tanggal_lahir: new Date('1992-08-30'), status_kawin: 'tidak_kawin', jumlah_anak: 0, tanggal_masuk: new Date('2015-03-10'), id_jabatan: 2, id_departemen: 10, usia: 33, status: 'Aktif', status_kontrak: 'PKWTT', jenis_kelamin: "Pria" },
      { id: 4, nip: '198811112013011003', nama_pegawai: 'Dewi Lestari', email: 'dewi.lestari@kepegawaian.go.id', nomor_hp: '+6281234567893', tempat_lahir: 'Yogyakarta', id_kecamatan: 8, alamat_lengkap: 'Jl. Gambir No. 5', jarak_rumah_kantor: 2, tanggal_lahir: new Date('1988-11-11'), status_kawin: 'Kawin', jumlah_anak: 3, tanggal_masuk: new Date('2013-01-05'), id_jabatan: 2, id_departemen: 9, usia: 37, status: 'Aktif', status_kontrak: 'PKWT', jenis_kelamin: "Wanita" },
      { id: 5, nip: '199506202018012004', nama_pegawai: 'Siti Aminah', email: 'siti.aminah@kepegawaian.go.id', nomor_hp: '+6281234567894', tempat_lahir: 'Semarang', id_kecamatan: 6, alamat_lengkap: 'Jl. Tanah Abang No. 12', jarak_rumah_kantor: 6, tanggal_lahir: new Date('1995-06-20'), status_kawin: 'tidak_kawin', jumlah_anak: 0, tanggal_masuk: new Date('2018-01-20'), id_jabatan: 3, id_departemen: 11, usia: 31, status: 'Aktif', status_kontrak: 'PKWTT', jenis_kelamin: "Wanita" },
    ],
    skipDuplicates: true,
  });
